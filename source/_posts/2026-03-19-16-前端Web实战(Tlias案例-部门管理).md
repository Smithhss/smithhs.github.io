...
tags:
  ...
  - 后端
categories: 编程开发
cover: 'https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314154345.png'
---
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314154345.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314154404.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314154419.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314154433.png)

* 启动前端项目，访问该项目

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314154534.png)

打开浏览器，访问 http://localhost:5173

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314154548.png)

在提供的基础工程中，最基本的页面布局，已经准备好了。 我们通过页面原型可以看到页面的布局如下：

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314154558.png)

其实要实现这个页面布局，我们可以借助于 `ElementPlus` 中提供的 container 容器布局。

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314154607.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314154626.png)

左侧菜单栏的制作，也不需要我们自己实现，其实在 `ElementPlus` 中已经提供了对应的菜单组件，我们可以直接参考【PS: 其实就是复制过来，参考页面原型和需求，将其改造成我们需要的样子就可以了】。

**参考代码的出处:**

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314154658.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314154731.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314154757.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314154833.png)
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314154844.png)

VueRouter主要由以下三个部分组成，如下所示：

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314154856.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314154933.png)

那要完成这个功能效果，我们就需要用到Vue生态中的路由 **`Vue-Router`**。

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314154944.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155000.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155016.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155036.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155050.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155113.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155125.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155143.png)

4\). 在 `vite.config.js` 中配置前端请求服务器的信息

在服务器中配置代理proxy的信息，并在配置代理时，执行目标服务器。 以及url路径重写的规则。

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155154.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155208.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155220.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155242.png)

点击保存之后，就会将数据保存到数据库，并重新查询出最新的数据，展示在页面中。

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155305.png)

#### 4.2.2 表单校验

Form 组件允许你验证用户的输入是否符合规范，来帮助你找到和纠正错误。`Form` 组件提供了表单验证的功能，只需为 `rules` 属性传入约定的验证规则，并将 `form-Item` 的 `prop` 属性设置为需要验证的特殊键值即可。

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155332.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155348.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155412.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155435.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155445.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155507.png)

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155524.png)


### 4.4 删除部门

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155537.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155601.png)
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250314155612.png)
