...
![image-20221205001501275](img/image-20221205001501275.png)
...
![image-20221205095039939](img/image-20221205095039939.png)
...
数据库都是属于关系型数据库，要操作关系型数据库都是通过 SQL语句来实现的，而SQL语句又是操作关系型数据库的统一标准。

> 结论：只要我们学会了SQL语句，就可以通过SQL语句来操作Mysql，也可以通过SQL语句来操作Oracle或SQL Server

以上课程内容拆解为3部分知识点：

![image-20221205122937131](img/image-20221205122937131.png)

## 1. MySQL概述

![image-20220610191829748](img/image-20220610191829748.png) 
...
![image-20221205140643412](img/image-20221205140643412.png)

这个安装包呢，大家可以不用下载，因为资料中已提供现成的安装包。 ![image-20221205140732982](img/image-20221205140732982.png)
#### 1.1.3 连接

MySQL服务器启动完毕后，然后再使用如下指令，来连接MySQL服务器：

```
mysql -u 用户名 -p密码 [-h数据库服务器的IP地址 -P端口号]
```
...
![image-20221205143139656](img/image-20221205143139656.png)

- 密码在-p回车之后，在命令行中输入密码，然后回车

![image-20221205143418632](img/image-20221205143418632.png) 
...
![image-20220829110618240](img/image-20220829110618240.png) 
...
![image-20220829111237340](img/image-20220829111237340.png) 
...
![image-20220829111522126](img/image-20220829111522126.png)

### 1.2 数据模型

在Mysql数据库当中到底是如何来存储和管理数据的。
...
![image-20221205145028667](img/image-20221205145028667.png) 
...
在Mysql数据库当中到底是如何来存储数据的，也就是Mysql 的数据模型。

MySQL是关系型数据库，是基于二维表进行数据存储的，具体的结构图下:

![image-20220829111741419](img/image-20220829111741419.png) 
...
![image-20221205151656214](img/image-20221205151656214.png)

2、SQL语句可以使用空格/缩进来增强语句的可读性。

![image-20221205151953441](img/image-20221205151953441.png)

3、MySQL数据库的SQL语句不区分大小写。

![image-20221205152112070](img/image-20221205152112070.png)
...
![image-20221205152804250](img/image-20221205152804250.png)  
...
![image-20220829112953742](img/image-20220829112953742.png)

需求文档：

- 在我们开发一个项目或者项目当中的某个模块之前，会先会拿到产品经理给我们提供的页面原型及需求文档。

![image-20221205154101142](img/image-20221205154101142.png)
...
![image-20220829124104154](img/image-20220829124104154.png) 
...
![image-20221205174615074](img/image-20221205174615074.png)
...
![image-20250611135400203](img/image-20250611135400203.png)

注意：在同一个数据库服务器中，不能创建两个名称相同的数据库，否则将会报错。

![image-20250611135443627](img/image-20250611135443627.png)

- 可以使用if not exists来避免这个问题

```sql
-- 数据库不存在,则创建该数据库；如果存在则不创建
create database if not extists zhisheng; 
```
...
~~~mysql
drop database if exists zhisheng; -- zhisheng数据库存在时删除 
~~~
...
![image-20221205184802646](img/image-20221205184802646.png)
...
说明：NavicatPremium-16.3.2.0.x64-绿色免安装解压版这款工具可以不用安装，解压即可使用,且功能强大。

#### 2.3.3 使用

![image-20250611140124427](img/image-20250611140124427.png)

![image-20250611140306746](img/image-20250611140306746.png)
...
![image-20221205190929756](img/image-20221205190929756.png)

2、配置MySQL

![image-20221205191143072](img/image-20221205191143072.png)



3、输入相关信息

![image-20221205192606038](img/image-20221205192606038.png) 

4、下载MySQL连接驱动

![image-20221205192847190](img/image-20221205192847190.png)

5、测试数据库连接

![image-20221205193304124](img/image-20221205193304124.png)

6、保存配置

![image-20221205193409856](img/image-20221205193409856.png)
...
![image-20221205195346655](img/image-20221205195346655.png)

![image-20221205195510716](img/image-20221205195510716.png)
...
![image-20221205195128343](img/image-20221205195128343.png)

![image-20221205195833439](img/image-20221205195833439.png)
...
![image-20220829143005524](img/image-20220829143005524.png)  
...
![image-20221205211008929](img/image-20221205211008929.png)
...
![image-20221205214447060](img/image-20221205214447060.png) 
...
> - id 是一行数据的**唯一标识**
>
> - username 用户名字段是**非空且唯一**的
>
> - name 姓名字段是**不允许存储空值的**
>
> - gender 性别字段是**有默认值**，默认为男
...
![image-20221205215309011](img/image-20221205215309011.png)

![image-20221205215632599](img/image-20221205215632599.png)
...
> 参考资料中提供的《智能学习辅助系统》页面原型，设计员工管理模块的表结构
>
> 暂不考虑所属部门字段

产品原型及需求如下：

![image-20220829151032029](img/image-20220829151032029.png)

![](img/image-20220829151228102.png)

![](img/image-20220829151245450.png)
...
![image-20221205230447721](img/image-20221205230447721.png)

2. 编辑表结构的相关信息

![image-20221205231846161](img/image-20221205231846161.png)
...
![image-20221205232253088](img/image-20221205232253088.png)
...
![image-20221205233746548](img/image-20221205233746548.png)
...
![image-20221205234114053](img/image-20221205234114053.png)
...
![image-20221205234334696](img/image-20221205234334696.png)

![image-20221205234444906](img/image-20221205234444906.png)
...
![image-20221205235542272](img/image-20221205235542272.png)

![image-20221205235657807](img/image-20221205235657807.png)
...
![image-20221205235950010](img/image-20221205235950010.png)

![image-20221206000030734](img/image-20221206000030734.png)
...
![image-20221206000159237](img/image-20221206000159237.png)
...
![image-20221206000636659](img/image-20221206000636659.png)
...
![image-20221206001026916](img/image-20221206001026916.png) 
...
![image-20221206002807531](img/image-20221206002807531.png)

Insert操作的注意事项：

1. 插入数据时，指定的字段顺序需要与值的**顺序是一一对应**的。
2. 字符串和日期型数据应该**包含在引号中**。
...
![image-20221206004425527](img/image-20221206004425527.png)
...
![image-20220611103943417](img/image-20220611103943417.png) 
...
![image-20221206112810199](img/image-20221206112810199.png)
...
![image-20221206113904763](img/image-20221206113904763.png)
...
![image-20221206114752149](img/image-20221206114752149.png)
...
![image-20221206115440117](img/image-20221206115440117.png)
...
![image-20221206121255784](img/image-20221206121255784.png)
...
![image-20221206121523712](img/image-20221206121523712.png)
...
![image-20221206121754267](img/image-20221206121754267.png)

> 注意：查询为NULL的数据时，不能使用 `= null`
>
>![image-20221206122036970](img/image-20221206122036970.png)
...
![image-20221206122454101](img/image-20221206122454101.png)
...
![image-20221206122712152](img/image-20221206122712152.png)
...
![image-20221206125100857](img/image-20221206125100857.png)
...
![image-20221206125356737](img/image-20221206125356737.png)
...
![image-20221206141451342](img/image-20221206141451342.png)
...
![image-20221206141937293](img/image-20221206141937293.png)
...
![image-20221206142156154](img/image-20221206142156154.png)
...
![image-20221206160145339](img/image-20221206160145339.png)
...
![image-20221206160307416](img/image-20221206160307416.png)
...
![image-20221206160416605](img/image-20221206160416605.png)
...
![image-20221206160604073](img/image-20221206160604073.png)
...
![image-20221206172615000](img/image-20221206172615000.png)
...
![](img/image-20221206172431873.png)
