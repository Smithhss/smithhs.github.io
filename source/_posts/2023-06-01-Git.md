...
[Debian/Linux安装Git](#t3)

[配置git环境：git config --global](#t4)

[创建本地空仓库：git init](#t5)

[新建文件添加到本地仓库：git add、git commit -m](#t6)

[改写提交：git commit --amend](#t7)

[查看历史提交日志：git log](#t8)

[回滚代码仓库：git reset --hard](#t9)

[查看提交之后文件是否做了改动：git status](#t10)

[工作区与缓存区](#t11)

[修改缓存区内容：git add、git commit -m](#t12)

[将改动文件添加到缓存区：git add](#t13)

[将所有改动文件添加到缓存区：git add --all、git add .](#t14)

[将文件撤销回到最近一次修改的状态：git checkout -- file](#t15)

[查看单个文件可回滚版本：git log filename](#t16)

[删除文件：git rm](#t17)

[查看提交历史：git reflog](#t18)

[git基本组成框架：Workspace、Index / Stage、Repository、Remote](#t19)

[git rm后恢复文件：git rm、git reset、git checkout](#t20)

[git创建分支：git branch、git checkout](#t21)

[git切换分支：git checkout](#t22)

[git合并分支：git merge](#t23)

[git查看分支：git branch -a](#t24)

[git删除本地分支：git branch -D](#t25)

[git删除远程分支：git push origin --delete](#t26)
...
[github将本地仓库关联到远程仓库：git remote add origin](#t30)

[git将远程仓库关联到本地和拉取指定分支、切换远程分支：git clone](#t31)

[github提交本地仓库到远程仓库：git add、git commit、git push](#t32)

[git修改分支名称：git branch](#t33)

[git保存当前工作切换分支：git stash](#t34)

[将别的分支修改转移到自己的分支：git cherry-pick](#t35)

[git远程删除分支后本地git branch -a依然看得到的问题：git remote](#t36) 

[​](#t37)

[git强制合并分支：--allow-unrelated-histories](#t38)

[​](#t39)

[git拉取远程所有分支：git fetch](#t40)

[git子模块管理：git submodule](#t41)

[git分支开发步骤](#t42)

[git强制删除分支：git branch](#t43) 

[git查看不同分支的文件差异：git diff](#t44)

[git查看仓库信息：git remote](#t45)

[​](#t46)

[Git新增分支操作：git switch、git restore](#t47)

[搭建本地git服务器](#t48)

[Git问题总汇](#t49)

[error: src refspec main does not match any](#t50)

[Please make sure you have the correct access rights and the repository exists.](#t51)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/b7ab8f113c468a8e2127af9f65038798png.jpg)

初始化后会生成git的配置文件目录，普通的"ls"命令是看不到的，我们需要使用ls -ah查看隐藏目录

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/e4596e17f6a73eb863b494b71008e305png.jpg)

进入目录后可以看到它的相关配置文件

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/5b5a6259bffb6b2e4817e58eb0e1c33dpng.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/c5ee1bb9635e064c5547d7b80ce64ac3png.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/e68473874433a6a6c86202ce2f44df14png.jpg)

我们输入Y选中是

可以看到刚刚的注释信息

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/5180cb28b51f7693e20aa4f5ed563c99png.jpg)

在界面中按下“i”即可进入编辑界面

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/e083d7002e2ede0571a7a970d6f52451png.jpg)

修改完成后按下ctrl+o键

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/641c40e11a7a98fab955f9475ee9e03cpng.jpg)

在按下回车，就会提示已写入，用#是注释，不会被提交，git会自动过滤

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/0bf1728fd4f6adf24abbba4371234968png.jpg)

下面的^G和^O这种符号^在ascii里对应ctrl键，所以就是ctrl+x

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/9c3f7135fae1be4c36dc2cb987922615png.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/74c5d318bf96842af92003fd5f3af9bcpng.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/b8e2bb402d2c2e311fcfa3d4f90a0ed0png.jpg)

回滚的时候我们只需要字符，其它的都不需要！

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/f7c951d26f581820e8e34f4cc1492885png.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/00570a3f99207fbabb935f00d1350c54png.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/7ba949e9a2a8a764101340d3d131c979png.jpg)

保存退出，然后使用git status查看

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/e54e6cedc65f666329014ceb3afd1919png.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/fb639d263322f2b09e4b795646660829png.jpg)

如果不是中文会在后面写一个Untracked代表未提交

我们使用git add提交到缓存区文件后，使用git status也可以查看到当前文件的状态

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/5586ac8bc8d75119d1e75bc0eebc997dpng.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/e0308ecda4ba89622b5a9345665bee92png.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/171edfbf4931976886b49810d0c42a4cpng.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/a1cf2d2e51aef3f6c51bf6ba046f2c5apng.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/b79a061ad9a4fb525005f4129292bcfdpng.jpg)

```bash
git log min.c
```

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/2e649a59acb2431b24b9a81a816a574apng.jpg)
...
```bash
git add min.cgit commit -m "new"
```

更新完成后可以在使用log查看一下，会发现多出一个历史版本

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/37bceec72f28bc62cd945c90b71676c9png.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/2ed8c12ddfae164317e9f50c9ddea81dpng.jpg)

当然你也可以使用git rm删除文件，但是也需要使用git commit提交一次

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/602eabb965df1c24d2f4061191a1d629png.jpg)

可以看下status的状态

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/60ea970cdfc1bde0936d1f1503dab311png.jpg)

## 查看提交历史：git reflog

git reflog可以查看当前版本库的提交历史，凡是对仓库版本进行迭代的都会出现在这个里面，包括你回滚版本都会出现在这个历史中

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/89bb5dc4e15de4d73f10f8ef4111e898png.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/98d902298fa589dde2a3650bbad1a822png.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/40d073c7fddd283d7b12fc934139011dpng.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/e5618fb1d701e4d6f43f5aff7d2553b1png.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/7eb9db0d256e70032ee8100b4c6daabepng.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/341020d43c00f5a427e1965d833ae972png.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/cb9ab426a8e2698244e272543bdc61b9png.jpg)

生成的ssh文件如果不使用-f指定的话会生成在用户目录下的.ssh目录中，.ssh是隐藏文件，可以使用ls -ah看到，使用cd ~进入用户主目录，然后cd进入到.ssh目录中可以看到文件

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/d72a9cabe864d92ad12fa410ab99c410png.jpg)

id\_rsa是私匙，id\_rsa.pub是公匙，id\_rsa不能告诉任何人，只有公钥可以，ssh采用的是非对称加密。

接着在github上添加你的公钥

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/9959ff30b5ec200a1efc24251645e7f0png.jpg)

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/a0d3090a89910c34aea8cc2b3ff6b229png.jpg)

最后在输入你的登录密码就可以了

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/e2135b9e09b0645cddd077dda1029d60png.jpg)

这样ssh就添加成功了~

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/fcd57ab857b2e074acf2aacf4465ae8dpng.jpg)
...
![在这里插入图片描述](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/7834d0576dd170d50efca0b01a1dde93png.jpg)

## github上创建仓库

我们可以在github上创建一个仓库

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/aaec36e6714065cb7a8005dcd77ce73bpng.jpg)

创建时记得选上readme文件，因为这个文件是github上的md文件，用来显示项目简介的，建议选上，日后我会教大家如何去写md文件，或者可以去使用一些在线的md文件生成网站也可以。

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/0a52e79dcd757c4018560b86d9482275png.jpg)

创建完成之后就是这个样子的

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/34bf1bb728527a449d6065d92cf27183png.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/abb2d656b8923081efab0254acf66447png.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/ca579f0ca197035be29e31ff58e5bb6dpng.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/3b7af617d556929ad1c42d9d061a6a87png.jpg)

这个时候你可以在github上看到有提交记录

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/4c3ea1f04cc3279446586738a9181a8fpng.jpg)

但是什么都没有，因为这个分支是main，我们提交的是master

选中它然后切换到master

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/7c1f39ecb5afdb8bb584047ea7e7b3d6png.jpg)

默认是没有master的，这是我们新添加的分支

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/ce1810eddd481809d287e9afc95d8ec1png.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/bf4fad9cb3c8e9beae7c52642f3fa747png.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/763103187e03d81b57e71256e5c31ad5png.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/38dfa47e8db3f5f9993509e49be2c2ebpng.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/ded26768ae84e6c7b64a8fa8ae5f97ecpng.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/148e8cfa8091905f4f791c5dd6116612png.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/a0bf21d771c3d68e1b191cca7769b66epng.jpg)
...
## ![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/ab4959bbf73abb677e883eecaf62e8c2png.jpg)
...
## ![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/663e82453514421839f3e32495bab662png.jpg)

## git拉取远程所有分支：git fetch

当我们在本地进行开发时，有时会发现有些分支看不见

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/1f3b5a637119d8c77e70edb033fdeb72png.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/ac0e1e6b3c79fa538541f9a5f9342a67png.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/6ab152d25be9dba40414f78c037fa548png.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/444f15504f48307e90f828bfb3c3d52bpng.jpg)
...
## ![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/cb10c053cb6348e72dd6b3142ce827e2png.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/194d49249357ea740b735d47ec309b3bpng.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/ae2de200efc98f6571f21a77a101e1ffpng.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/818d4e3eca37ac70ad0f4377991eceabpng.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/ddc6e940e92c706ea003d79fa67f6e8epng.jpg)
...
![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/22d6ad289bb6196c5b9ae08e3a3b6d4cpng.jpg)
