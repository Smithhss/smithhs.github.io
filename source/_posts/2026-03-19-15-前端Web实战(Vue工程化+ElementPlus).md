---
title: 15-前端Web实战(Vue工程化+ElementPlus)
date: 2026-03-19 20:10:28
tags:
  - Java
  - JavaWeb
  - 后端
categories: 编程开发
cover: 'https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170013.png'
---
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170013.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170028.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170045.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170113.png)

#### 1.2.2 NodeJS安装

安装包，在课程资料中已经提供了。如下：

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170132.png)

**1). 双击msi文件，勾选我接受**

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170144.png)

**2). 选择安装到一个，没有中文，没有空格 的目录下（新建一个文件夹NodeJS）**

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170207.png)

**3). 点击 Next，下一步下一步的安装即可。**

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170231.png)

**4). 验证NodeJS的环境变量**

NodeJS 安装完毕后，会自动配置好环境变量，我们验证一下是否安装成功，通过： `node -v`

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170247.png)

**5). 配置npm的全局安装路径**

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170306.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170354.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170415.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170500.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170515.png)

这是我们创建的第一个项目结构，接下来呢，我们来介绍一下这个项目的结构。如图所示：

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170528.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170551.png)

* **方式二：Vscode图形化界面**

点击NPM脚本中的dev后的运行按钮，就可以启动项目。

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170631.png)

启动起来之后，我们就可以访问前端Vue项目了，访问路径： http://localhost:5173

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170654.png)
### 1.4 Vue项目开发流程

如下图：

![](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170713.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170750.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313170958.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313171020.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313171637.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313171659.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313171720.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313171753.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313171810.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313171839.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313171852.png)

接下来我们通过代码来演示。

首先我们需要来到 ElementPlus 的组件库中，找到表格组件，如下图所示：

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313171909.png)

然后在 `Element.vue` 组件中继续制作表格。组件中，需要注意的是，我们组件包括了3个部分，如果官方有除了`<template>`部分之外的`<style>`和`<script>`都需要复制。具体操作如下图所示：

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313171921.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313171943.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313171956.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313172018.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313172047.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313172104.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313172124.png)

首先我们需要在ElementPlus官方找到Dialog组件，如下图所示：

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313172139.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313172205.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313172216.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313172243.png)

### 2.4 案例

需求：基于ElementPlus组件库制作如下页面，并异步获取数据，完成页面展示。

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313172308.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313172344.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313172409.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313172504.png)

**1). 双击msi文件，勾选我接受**

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313172520.png)


**2). 选择安装到一个，没有中文，没有空格 的目录下（新建一个文件夹NodeJS）**

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313172543.png)


**3). 点击 Next，下一步下一步的安装即可。**

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313172601.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313172615.png)


**5). 配置npm的全局安装路径**

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250313172635.png)
