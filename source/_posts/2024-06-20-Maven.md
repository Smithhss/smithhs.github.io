...
![image-20220531105056629](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/e5eb78647118762dd63538d09298e766png.jpg)

#### 1.1 构建

Java 项目开发过程中，构建指的是使用『**原材料生产产品**』的过程。

![image-20220531103123865](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/c633ec8fcdddbd7f00edf9aeac69d688png.jpg)

构建过程主要包含以下环节：

![image-20220531110053525](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/c52769d3f81b03addf9988db6a56283epng.jpg)
...
![image-20220531111722652](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/6fa0f6b8fbc3611c85089c4931fecde7png.jpg)

或者你也可以选择之前的版本：

![image-20220531111953804](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/0b02df697bd1adf0a3d6ab0bdb8b59eepng.jpg)

然后里面选择自己对应的版本下载即可：

![image-20220531112022942](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/293533977e93409db9187c5c13546bb2png.jpg)

下载之后解压到**非中文、没有空格**的目录，如下：

![image-20220531112226829](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/fb2d52642f2395ab9d3e19bfe737c59cpng.jpg)
...
![image-20220531113102962](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/59aa5c32eb7ab7fd7a7c9ae2e7af07dapng.jpg)
...
![image-20220531113203150](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/c1cfd47c721e21c184e759f6713a7186png.jpg)
...
![image-20220531113255988](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/64665383506a16a56dbcc54b43d61c12png.jpg)
...
![image-20220531115849117](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/a6c2390876c3baa5989c102232a29ab3png.jpg)
...
![image-20220531154214396](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/437f69a4e38e1919576b398b962bc169png.jpg)
...
![image-20220531160955790](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/4b2f8c774b6220c5b3702f1d50f1d2dfpng.jpg)

![image-20220531161201700](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/cd904a435d10e5ee31a523a0ed97901apng.jpg)
...
![image-20220531161702343](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/60dcc354a60665d2eb9a94d34c940890png.jpg)

![image-20220531161801726](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/b0c50e1df156a6357ee04e13b45c2ec2png.jpg)

![image-20220531161912958](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/464eb9de4f9959f5f70b2ea865b0090dpng.jpg)

然后可以再**父工程**的 pom 文件中看到：

![image-20220531162441081](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/82145020b582e6d29ff9fb7661ccda80png.jpg)

而**子工程**的 pom 如下：

![image-20220531162755291](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/3cc8e66af1357630f446ee15e68b9269png.jpg)
...
![image-20220531163659123](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/effaefb57971e23fed3b580d99d1e2b2png.jpg)

**⑤ 修改父工程依赖信息的版本**

这个修改可以是降级，也可以是升级，但一般来说都是升级。

![image-20220531164037374](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/55d45e72c40c5f47411750af2af237bdpng.jpg)
...
![image-20220531164745206](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/846e36fa40de49a49cf88f288d1c7975png.jpg)
...
![image-20220601152649666](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/e2dd6d87b36340a68d8eb8f8d5c4b48dpng.jpg)
...
![image-20220601162525659](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/3e268959d94952e2ff6a346604a4d477png.jpg)

这里我们可以对接 profile 这个单词中『侧面』这个含义：项目的每一个运行环境，相当于是项目整体的一个侧面。

![image-20220601162550102](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/4244e7b52aaa2e069442921115c8595dpng.jpg)
...
![image-20220601162840282](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/782d3740b1c224a980b3b15790de2953png.jpg)
...
![image-20220606114707970](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/d6f13944c48be81c2b724eff49ff86a2png.jpg)
...
![image-20220606112441832](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/12a7514431061d223164c21dd4e5c53bpng.jpg)

`application.yml` 中配置`spring.profiles.active=prod`（或者dev、test）指定使用的配置文件，如下：

![image-20220606115635516](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/28a1cfc6e21e2dbb06d91deee5a0ed75png.jpg)

注：`profileActive`，就是上面我们自定义的标签。

然后当我们勾选哪一个环境，打包的配置文件就是那一个环境：

![image-20220606142000391](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/623119cb7a1df44b3093ba4bb8d4427cpng.jpg)
...
![image-20220606143030533](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/6eca62f7e9e90eb01c5dadc1b9834bd5png.jpg)
...
![image-20220606144656822](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/6c11f80342fe6950c395bf12daa5a46dpng.jpg)
...
![image-20220606145226352](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/f9722fc4b3a4ac1b4863bc7a3461a399png.jpg)
...
![image-20220606145457084](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/d83c41ad8bc7305d7dfe429c98962b7epng.jpg)

可以看到 8081 端口被占用，而 nexus 的默认端口为 8081，我们可以修改其默认端口号，其配置文件在 `etc`目录下的`nexus-default.properties`，如下：

![image-20220606145845965](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/29f6cf1a7fa2f70897046d15734a80ccpng.jpg)

打开后修改为自己需要设置的端口，注意开启对外防火墙：

![image-20220606145927153](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/09daeca2b24ba6d596b0e8d5d86977dapng.jpg)
...
![image-20220606151654339](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/bd8a6ee548eacae27d4e814c239ba2e7png.jpg)

#### 7.2 初始设置

点击右上角的登录：

![image-20220606152046968](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/c16ce008634d2f948c7119c5383339b2png.jpg)
...
![image-20220606152336266](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/d51618897ff97bd202c680471051ed40png.jpg)

匿名登录，启用还是禁用？由于启用匿名登录后，后续操作比较简单，这里我们演示禁用匿名登录的操作方式：

![image-20220606152408234](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/1a4df2b6ed9c2b242480549033843c38png.jpg)

除了默认账号 admin，admin 具有全部权限，还有 anonymous，anonymous 作为匿名用户，只具有查看权限，但可以查看仓库并下载依赖。

完成：

![image-20220606152430477](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/2874a094b2c45cbf8d9602b544dab7f2png.jpg)

#### 7.3 Nexus Repository

nexus 默认创建了几个仓库，如下：

![image-20220606152951773](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/b55ca12298c7bb12a04eb07f154dc75epng.jpg)
...
![image-20220606153439317](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/976ee47fd0891f6f805e78ee5908e3cdpng.jpg)
...
![image-20220606182445347](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/5fa14fc074906d9e04fa031b78eb84bcpng.jpg)

然后创建仓库，如下：

![image-20220606182816648](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/99341ab1d19e54353edff686342d5fa5png.jpg)

同理创建 releases 仓库，然后查看列表：

![image-20220606182955022](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/983704de3ba7976733cb04b2caf169e4png.jpg)
...
![image-20220606183224448](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/83c97d48b3b25f43bc3347112f772117png.jpg)

然后创建：

![image-20220606183625913](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/d602e3343558165c8a05927321525d06png.jpg)
...
![image-20220606183938914](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/31b97ee2566cd30bde1d07c7a5d02b78png.jpg)

查看 Nexus 仓库列表，可以看到创建的仓库组已经创建完成，如下图：

![image-20220606184518165](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/1e08af0832efd7fa5f491a8264da43aepng.jpg)

#### 7.5 通过 Nexus 下载 jar 包

由于初始状态下都没有内容，所以我们需要进行配置，我们先在本地的 Maven 的配置文件中新建一个空的本地仓库作为测试。

![image-20220606154105497](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/80384908e0e5b4279d1ee88a86dd603cpng.jpg)
...
![image-20220606154441373](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/b68a1246a8d09439211917d0f6ab3511png.jpg)
...
![image-20220606160556887](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/dd49c3c86d45f5ba236d8b370b9fa968png.jpg)

下载后，Nexus 服务器上就有了 jar 包：

![image-20220606160657138](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/8bfca300174a4e578e8e0be75ae363a0png.jpg)
...
![image-20220606165417072](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/0a6499d9fffb1397107d5642fcb8a413png.jpg)

##### 7.6.2 上传到 maven-releases

修改项目的版本，如下：

![image-20220606165516336](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/1b5ff1be390aa416f3370d1b24ea4732png.jpg)

执行命令 `mvn deploy`：

![image-20220606165553247](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/48d7b8fdb92343b08ad72386182c3f44png.jpg)

查看：

![image-20220606165642474](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/a06ecac6e8ad68e59170a605d8a864b8png.jpg)
...
+   **最短路径优先**
    ...
    ![image-20220607101311677](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/fe79c25283d7cb9dd7edd6bf10c030dbpng.jpg)
    
+   **路径相同时先声明者优先**
    
    此时 Maven 采纳哪个版本，取决于在 pro29-module-x 中，对 pro30-module-y 和 pro31-module-z 两个模块的依赖哪一个先声明。
    
    ![image-20220607101401799](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/00ebf1d7c7540813cfed91d540a5cfb3png.jpg)
...
![image-20220607101724531](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/f453f98547fb3652426b69ba5cd1f279png.jpg)
...
![在这里插入图片描述](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/12e49c7a40e16c608c17a5d1f9bf44e8png.jpg)
...
![image-20220607103315557](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/9b19641e8e4b777258de40df8153a296png.jpg)

然后基于 pom.xml 的依赖冲突分析，如下：

![image-20220607103654229](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/d580ebf0f827371e9c9aea3b4a388dafpng.jpg)

查看冲突分析结果：

![image-20220607103711944](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/ac1cf22163b533ec3e9f43635c93c937png.jpg)
...
![image-20220607113428085](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/3fdbea9947b536a4c425b846941cc349png.jpg)  
