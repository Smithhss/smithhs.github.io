---
title: 10-后端Web实战(员工管理)
date: 2026-03-19 20:01:20
tags:
  - Java
  - JavaWeb
  - 后端
categories: 编程开发
cover: 'https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308161321.png'
---
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308161321.png)

除了员工管理的功能以外，我们还要完成员工信息统计的功能，包括：员工职位统计、员工性别统计。

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308161329.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308161933.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308162024.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308164524.png)

控制台SQL语句：

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308165029.png)

### 1.6 前后端联调

打开浏览器，测试后端功能接口：

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308165048.png)

## 2. 修改员工

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308165222.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308165427.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308165525.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308180942.png)

#### 2.1.5 前后端联调测试

打开浏览器，进行前后端联调测试。

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308182059.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308182212.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308182230.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308182817.png)
#### 2.2.5 前后端联调

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308182837.png)

点击保存之后，查看更新后的数据。

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308182938.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308202452.png)

状态码为500，表示服务器端异常，我们打开idea，来看一下，服务器端出了什么问题。

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308202905.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308202951.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308203024.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308203311.png)

* **方案二：全局异常处理器**

好处：简单、优雅（推荐）

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250308203449.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250309005928.png)
### 4.1 职位统计

#### 4.1.1 需求


![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250309132554.png)

对于这类的图形报表，服务端要做的，就是为其提供数据即可。 我们可以通过官方的示例，看到提供的数据其实就是X轴展示的信息，和对应的数据。

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250309132626.png)

#### 4.1.2 接口描述

参照资料中提供的接口文档，查看 **`数据统计`**  -> **`员工职位统计`** 接口的描述。

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250309141935.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250309142007.png)

#### 4.1.5 联调测试

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250309142026.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250309142050.png)

对于这类的图形报表，服务端要做的，就是为其提供数据即可。 我们可以通过官方的示例，看到提供的数据就是一个json格式的数据。

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250309142101.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250309142146.png)

#### 4.2.5 联调测试

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250309142154.png)
