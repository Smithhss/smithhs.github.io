---
title: 07-后端Web实战(部门管理)
date: 2026-03-19 19:54:29
tags:
  - Java
  - JavaWeb
  - 后端
categories: 编程开发
cover: 'https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216103352.png'
---
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216103352.png)

* 员工管理

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216103458.png)

* 员工信息统计

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216103513.png)

* 学员信息统计

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216103525.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216103631.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216103655.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216103749.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216105853.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250304142231.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216110042.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216110113.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216110137.png)

##### 1.1.3.2 安装

下载Apifox的安装包（资料中已经提供），直接双击安装 。

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216110530.png)

安装完成之后，就可以扫码登录Apifox，就可以使用啦。。。

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216110626.png)

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250304143952.png)

### 1.2 工程搭建

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250304144342.png)

**1). 创建SpringBoot工程，并引入web开发起步依赖、mybatis、mysql驱动、lombok。**

* 创建项目

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216110743.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216125927.png)
...
* 基础代码结构
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216130509.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216131419.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216135826.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250304172301.png)
#### 2.1.4 代码实现
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216155425.png)

我们发现，已经查询出了所有的部门数据，并且响应回来的就是json格式的数据，与接口文档一致。 那接下来，我们再来测试一下，这个查询操作，我们使用post、put、delete方式来请求，是否可以获取到数据。

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216162801.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216163027.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216163132.png)

* `@Result`源代码：

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216163206.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216163332.png)

**2). 解压(解压到当前目录)**

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216163349.png)

**3). 双击 `nginx.exe` 启动Nginx，一闪而过，就说明nginx已启动完成。**

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216163406.png)

如果在任务管理器中，能看到上述两个进程，就说明nginx已经启动成功。

**4). 打开浏览器，访问：[http://localhost:90](http://localhost:90/)**

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216163428.png)

#### 2.2.2 请求访问流程

前端工程请求服务器的地址为 `http://localhost:90/api/depts`，是如何访问到后端的tomcat服务器的？

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216163515.png)

其实这里，是通过前端服务Nginx中提供的反向代理功能实现的。

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216163524.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216163708.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250304195205.png)

具体的请求访问流程如下：

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250304195804.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216164006.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216164111.png)
### 3.4 简单参数接收
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216164525.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216164548.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216164614.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216164712.png)
...
在`DeptService`中增加接口方法add，具体代码如下：
...
代码编写完毕之后，我们就可以启动服务，进行测试了。
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216165101.png)

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216165114.png)

## 5. 修改部门

对于任何业务的修改功能来说，一般都会分为两步进行：查询回显、修改数据。

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216165136.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216165154.png)
#### 5.1.2 接口描述
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216165221.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250305151141.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216165447.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216165634.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216165704.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216165740.png)

修改完成之后，我们可以看到最新的数据，如下：

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216165801.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216165903.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216165952.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216194026.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250306003201.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216194453.png)


由于第一个插件 maven-compiler-plugin 的引入导致了这个问题，解决这个问题的方案呢，就是直接将第一个插件删除即可。

![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216194514.png)
...
![image.png](https://smith-1315833455.cos.ap-beijing.myqcloud.com/blog/20250216194525.png)
